...
@app.put('/usuarios/{id}')
def update_usuario(updatedUsuario: Usuario) -> dict:
    """
...
@app.put('/docente/{id}')
def update_docente(updatedDocente: Docente) -> dict:
    """
...
@app.put('/cursos/{id}')
def update_curso(updatedCurso: Curso) -> dict:
    """
    ...
    Returns:
        dict: Mensaje de confirmación.
    """
    conn_curso.update_curso(updatedCurso)
